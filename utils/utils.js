...
Utils.OauthRequest = async (scriptId, deployId , auth, reqBody, method) => {
    var NETSUITE_ACCOUNT_ID  = ENV.NETSUITE_ACCOUNT_ID
    var BASE_URL             = 'https://' + NETSUITE_ACCOUNT_ID.toLowerCase().replace('_','-') + '.restlets.api.netsuite.com/app/site/hosting/restlet.nl'
...
Utils.getWorkatoResponse = async (url) =>{
    try {
